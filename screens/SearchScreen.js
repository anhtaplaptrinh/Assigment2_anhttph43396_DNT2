...
const SearchScreen = ({ navigation }) => {
  ...
  const [section, setSection] = useState([{ title: "Tất cả", id: 1, hide: true, loaiSP: "Cây trồng" }, { title: "Ưa bóng", loaiSP: "Cây trồng", id: 4 }, { title: "Hàng mới về", loaiSP: "Cây trồng", id: 5 }, { title: "Ưa sáng", loaiSP: "Cây trồng", id: 6 }]);
